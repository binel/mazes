 ...
 * diagonal character, and two sides of the maze will always have completely open 
 * corridors. In this implementation it is the bottom and right walls. Here is an 
 * example maze: 
 *
 * +---+---+---+---+---+ 
 * |       |       |   |
